    ...
    <>
      <div className="min-h-screen flex flex-col items-center justify-center bg-white px-6">
        <h1 className="text-center leading-[1] text-[28px] font-bold font-[Boston] text-black mb-4">
          The right colors make <br />
          all the difference.
        </h1>
        <p className="pl-4 pr-4 text-center leading-[1] text-[14px] font-normal font-[Boston] text-[#5B5B5B] max-w-md mb-8">
          We decode your skin tone and undertone to curate<br/> a color palette that
          elevates your look and <br/>complements your natural glow.
        </p>
        <div className="mb-8">
          <Image
            src="/assets/loader-3.svg"
            alt="loader-3"
            width={200}
            height={120}
