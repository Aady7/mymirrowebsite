                ...
                {['streetwear', 'business casual', 'athleisure'].map(style => (
                    <label key={style} className="flex items-center justify-center">
                        <input
                            ...
                            className="hidden"
                        />
                        <div className={`w-full py-4 px-6 rounded-lg text-center cursor-pointer transition-all ${formValues.goToStyle?.includes(style) ? 'bg-[#007e90] text-white' : 'bg-white text-gray-700 border-2 border-gray-200'
                            }`}>
